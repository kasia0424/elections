...
ActiveRecord::Schema.define(:version => 20150209122416) do
  ...
  add_index "useers", ["email"], :name => "index_useers_on_email", :unique => true
  add_index "useers", ["reset_password_token"], :name => "index_useers_on_reset_password_token", :unique => true
